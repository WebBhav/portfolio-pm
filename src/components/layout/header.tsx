  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'text-muted-foreground hover:text-foreground hover:bg-accent/10', // Default style, no active state
        className
      )}
    >
      {children}
    ...
    <SheetClose asChild>
      <Link
        ...
        className={cn(
          ...
          'text-foreground/80 hover:text-foreground hover:bg-accent/10', // Default style, no active state
...
const Header = () => {
  ...
  const handleNavigationClick = useCallback((href: string) => {
    ...
    if (href.startsWith('#')) {
        ...
        // For non-hash links, Next.js router will handle navigation and GlobalLoaderWrapper will hide loader.
